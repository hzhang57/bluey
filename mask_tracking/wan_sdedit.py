...
def load_diffusers_pipeline(torch_module: Any, vae_class=None, pipeline_class=None) -> Any:
    ...
    pipe.vae.to(vae_device, dtype=torch_module.float16)
...
def _encode_prompt_on_cpu(pipe: Any, prompt: str, guide_scale: float, device: Any, dtype: Any) -> tuple:
...
class WanTI2VSDEdit:
    ...
    def generate(
        ...
        prompt_embeds, negative_embeds = _encode_prompt_on_cpu(
